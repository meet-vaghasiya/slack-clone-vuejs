            ...
            <div class="flex flex-col items-center justify-center gap-y-5">
                ...
                <div class="w-2/3 mx-auto ">
                    ...
                    <div class="flex flex-col gap-2">
                        ...
                        <p class="text-xs">Looking to create new workspace instead? <span
                                class="font-semibold text-link">Create
                                a new
                                workspaces</span></p>
                    </div>
                </div>
                <div class="w-full">
                    <p>You're already signed in to...</p>
                    <div class="flex items-center justify-between border rounded-lg border-content-primary">
                        <div class="flex items-center justify-center w-16 h-16 text-3xl text-white bg-content-secondary">
                            MV
                        </div>
                        <div class="flex items-center justify-between flex-1 px-3 gap-x-5">
                            <div>
                                <p>meet vaghasiya</p>
                                <p>meet.com</p>
                            </div>
                            <button class="px-2 py-1 border rounded-md border-content-primary">
                                Open
                            </button>
                        </div>
                    </div>
