    ...
    <div class="my-auto">
        <div class="p-2 mx-auto md:w-1/2 lg:w-1/3 text-content-primary">
            <div class="flex flex-col items-center justify-center gap-y-5">
                ...
                <p class="text-4xl font-bold">First, enter your email</p>
                <p>We suggest using the email ad you use at work.</p>
                <div class="w-2/3 mx-auto ">
                    ...
                    <div class="flex flex-col gap-2">
                        <p class="text-xs">By continue you're agreeing to our Main services Aggreement, User Terms of
                            Service, Privacy Policy, Cookie Plicy and slack supplemental Terms <span
                                class="font-semibold text-link">Find your
                                workspaces</span>
                        </p>
                    </div>
                </div>
