<template>
    <div class="w-full " @mouseover="handleHover">
        <Popover v-slot="{ open }" class="relative">
            <PopoverButton ref="activatorBtn"
                class="inline-flex items-center px-3 py-2 text-base font-medium bg-orange-700 rounded-md group hover:text-white focus:outline-none focus-visible:ring-2 focus-visible:ring-white/75">
                <slot name="activator">
                    <span>Solutions</span>
                </slot>
            </PopoverButton>
            ...
            <transition enter-active-class="transition duration-200 ease-out" enter-from-class="translate-y-1 opacity-0"
                ...
                <PopoverPanel
                    ...
                    <div class="p-5 overflow-hidden rounded-lg shadow-lg ring-1 ring-black/5">
                        <slot name="dropdown">
                            <div class="relative grid gap-8 bg-white p-7 lg:grid-cols-2">
                                <a v-for="item in solutions" :key="item.name" :href="item.href"
                                    ...
                                    <div
                                        class="flex items-center justify-center w-10 h-10 text-white shrink-0 sm:h-12 sm:w-12">
...
const activatorBtn = ref(null)

const handleHover = () => {
    activatorBtn.value.click()
}
</script>
